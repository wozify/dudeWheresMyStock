...
urlKeyWords = {
    ...
    "https://www.bhphotovideo.com/c/search?q=3080&filters=fct_category%3Agraphic_cards_6567": (
    "Add to Cart", True, False, 'BandH'),
    ...
    "https://www.amazon.com/stores/page/6B204EA4-AAAC-4776-82B1-D7C3BD9DDC82?ingress=0": (
    ">Add to Cart<", True, False, 'Amazon')
...
firefoxWebdriverExecutablePath = r'GECKO PATH HERE'
...
def alert(url):
    # sound to alert the website update
    ...
    toast.show_toast("3080 IN STOCK", url, duration=5)
    time.sleep(60)
